...
import 'package:capstone1/MyInfoPage/MyFavoriteStore.dart';
...
class _UserInfoPageState extends State<UserInfoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MainPageController>(
        builder: (controller) => GetBuilder<UserInfoController>(
                          ...
                          body: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: TextObject("내 정보", Colors.black, 30,
                                      FontWeight.bold),
                                ),
                                Padding(
                                  padding:
                                      ...
                                      child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              borderRadius: BorderRadius.only(
                                                  ...
                                                  bottomRight:
                                                      Radius.circular(20))),
                                          child: TextObject("확인", Colors.white,
                                              20, FontWeight.w300)),
                                    ),
                                  ),
                                ),
...
class ChangeInfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double height = MediaQuery.of(context).size.height;
    return GetBuilder<MainPageController>(
      builder: (controller1) => GetBuilder<UserInfoController>(
        builder: (controller2) => Center(
            child: Container(
                height: height * 0.6,
                margin: EdgeInsets.symmetric(horizontal: 16),
                ...
                child: Scaffold(
                    ...
                    body: Column(
                        ...
                        children: [
                          TextObject(
                              "회원정보 수정", Colors.black, 30, FontWeight.bold),
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 16),
                            child: TextObject("수정할 값을 입력해주세요!", Colors.black,
                                15, FontWeight.bold,
                                center: false),
                          ),
                          Form(
                                  ...
                                  try {
                                    ...
                                    var param = {
                                      ...
                                      'name': nicknameField.text == ''
                                          ? (data?['name'])
                                          : nicknameField.text,
                                      'storeDTOList': data?['storeDTOList']
                                    };
                                    // print(param);
                                    ...
                                    if (response.statusCode == 200) {
                                      ...
                                      controller1.onLoginSuccess(response.data);
                                      controller2.update();
